...
\pgfplotsset{
  ...
  sortedStyle/.style     = {color = red,       mark = diamond*},
  constStyle/.style     = {color = violet,       mark = asterisk},
  dynamicStyle/.style     = {color = cyan,       mark = pentagon*},
  staticStyle/.style     = {color = gray,       mark = pentagon*},
  BloomStyle/.style     = {color = gray,       mark = triangle*},
  SQFStyle/.style     = {color = orange,       mark = pentagon*},
  RSQFStyle/.style     = {color = violet,       mark = diamond*},
  BBloomStyle/.style     = {color = magenta,       mark = diamond*},
  GQFStyle/.style     = {color = red,       mark = *},
  TCFStyle/.style     = {color = teal,       mark = square*},
  88Style/.style     = {color = teal,       mark = square*},
  128Style/.style     = {color = orange,       mark = triangle*},
  1212Style/.style     = {color = red,       mark = diamond*},
  1216Style/.style     = {color = violet,       mark = asterisk},
  1632Style/.style     = {color = gray,       mark = triangle*},
  1232Style/.style     = {color = cyan,       mark = pentagon*},
  1616Style/.style     = {color = gray,       mark = pentagon*},
  1216UnalignedStyle/.style = {color = orange,       mark = pentagon*},
}